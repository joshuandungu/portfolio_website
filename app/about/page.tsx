		...
		<motion.div variants={ fadeIn('right', 0.3) } className = "space-y-6" >
			<h1 className="text-4xl font-bold" > About Me </h1>
				< p className = "text-lg text-muted-foreground" >
					I am a passionate software engineering student with a focus on innovation and problem - solving.
			...
			<h2 className="text-2xl font-semibold" > My Journey </h2>
				< p className = "text-muted-foreground" >
					Throughout my academic career, I've been involved in various projects that have
								helped me develop practical software development skills and theoretical knowledge.I believe in
			...
			<Card className="h-full card-gradient" >
				<CardContent className="p-6" >
					<h3 className="text-xl font-semibold mb-4" > Education </h3>
						< p className = "text-muted-foreground" >
							Currently pursuing a Bachelor's degree in Software Engineering with a focus on
									building practical and innovative software solutions.
								</p>
		</CardContent>
		</Card>
		</motion.div>
